...
echo
echo "=== 5/12 编辑保存路径（真实输入） ==="
node scripts/gui-edit-save.mjs "$VAULT" "$PORT"

echo
echo "=== 6/12 Live Preview / 表格 / Mermaid / 图片 ==="
